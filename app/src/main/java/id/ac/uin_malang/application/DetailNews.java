...
public class DetailNews extends AppCompatActivity {
    ...
    private static final String url_delete = "http://alvin8mmudhoffar.000webhostapp.com/delete.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar =(Toolbar)findViewById(R.id.toolbar_da);
        buttonDel = (Button)findViewById(R.id.delet);
        buttonUpdate = (Button)findViewById(R.id.updet);
        judul = (TextView)findViewById(R.id.judulNews);
        tanggal = (TextView)findViewById(R.id.tanggalDetail);
        //thumb_image = (NetworkImageView)findViewById(R.id.gambarDetail);
        ...
        if (!id_news.isEmpty()) {
            ...
            buttonDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    IkiDelete(id_news);
                    Toast.makeText(getApplicationContext(), "id "+id_news+ " selected", Toast.LENGTH_LONG).show();
...
//                    }
    ...
    private void IkiDelete(final String id){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url_delete, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e(Tag, "EROOR"+error.getMessage());
