...
public class adapterList extends RecyclerView.Adapter<adapterList.HolderItem> {
    ...
    public adapterList(List<ModelListAdmin> modelListAdmins, Context context){
    ...
    public HolderItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row,parent,false);
    ...
    public class HolderItem extends RecyclerView.ViewHolder{
        ...
        public HolderItem(View v){
            super(v);
            thumbnails = (ImageView) v.findViewById(R.id.imgList);
            tv_judul = (TextView) v.findViewById(R.id.tv_judul);
            tv_tanggal = (TextView) v.findViewById(R.id.tv_tanggal);
            recycleView = (RecyclerView)v.findViewById(R.id.recyclerTemp);
